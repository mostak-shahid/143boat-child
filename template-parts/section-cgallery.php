...
$animation = $mosacademy_options['sections-cgallery-animation'];
$animation_delay = ( $mosacademy_options['sections-cgallery-animation-delay'] ) ? $mosacademy_options['sections-cgallery-animation-delay'] : 0;
$title = $mosacademy_options['sections-cgallery-title'];
$content = $mosacademy_options['sections-cgallery-content'];
$gallery = $mosacademy_options['sections-cgallery-gallery'];
$large_size = $mosacademy_options['sections-cgallery-large-size'];
$gap = $mosacademy_options['sections-cgallery-gap'];
$layout = $mosacademy_options['sections-cgallery-layout'];
$gal_url = $mosacademy_options['sections-cgallery-url'];
$zoom = $mosacademy_options['sections-cgallery-zoom'];
...
do_action( 'action_avobe_cgallery', $page_details ); 
?>
<section id="section-cgallery" <?php if ($animation) echo 'data-wow-delay="'.$animation_delay.'s" class="wow '.$animation.'"' ?>>
	<div class="content-wrap">
		
		<?php 
		/*
		* action_before_cgallery hook
		* @hooked start_container 10 (output .container)
		*/
		do_action( 'action_before_cgallery', $page_details ); 
		?>
				<?php if ($title) : ?>				
		...
		<?php 
		/*
		* action_after_cgallery hook
		* @hooked end_div 10 
		*/
		do_action( 'action_after_cgallery', $page_details ); 
		?>	
	</div>
</section>
<?php do_action( 'action_below_cgallery', $page_details  ); ?>
<style>
.styling {
