...
function child_theme_enqueue_styles() {
    wp_enqueue_style( 'child-main', get_stylesheet_directory_uri() . '/css/child-main.min.css', array( 'main.min' ), wp_get_theme()->get('Version') );
    wp_enqueue_script( 'child-main', get_stylesheet_directory_uri() . '/js/child-main.min.js', 'jquery', wp_get_theme()->get('Version'), true );
